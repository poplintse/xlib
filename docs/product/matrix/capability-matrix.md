...
初始盘点于 2026-09-14，更新于 2026-09-16，基于代码与文档，非发布验收。业务定义以能力文件为准。Backend 列表示服务端支持职责，不表示终端功能；API 不是独立客户端，apple-shared 是共享实现包。
...
| [CAP-PROGRESS-SYNC](../capabilities/progress-sync.md) | active | done | done | not-evaluated | not-evaluated | not-evaluated | done |
